...
greaterThan msg min = Validator.check (Batteries.error @l msg <<< { min, value: _ }) (_ > min)
...
smallerThan ∷
  ...
  a →
  Batteries.Validator' m err' a a
smallerThan msg max = Validator.check (Batteries.error @l msg <<< { max, value: _ }) (_ < max)
